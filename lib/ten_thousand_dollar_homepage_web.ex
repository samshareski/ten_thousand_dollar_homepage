defmodule TenThousandDollarHomepageWeb do
  @moduledoc """
  ...
  def view do
    quote do
      use Phoenix.View,
        root: "lib/ten_thousand_dollar_homepage_web/templates",
        namespace: TenThousandDollarHomepageWeb
      ...
      import TenThousandDollarHomepageWeb.ErrorHelpers
      import TenThousandDollarHomepageWeb.Gettext
      alias TenThousandDollarHomepageWeb.Router.Helpers, as: Routes
    end
  end
